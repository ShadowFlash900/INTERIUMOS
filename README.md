...
<img width="108" height="108" alt="INTERIUMLOGO" src="https://github.com/user-attachments/assets/49bddfa0-616a-4a47-b85f-8cc73cc11aed" />
...
Если нужно, я могу:
- сгенерировать уменьшенную версию для README фронт-страницы GitHub,  
- подготовить автоматический boot-плагин demo и добавить в `boot/`,  
- создать SECURITY.md и CONTRIBUTING.md.
